...
<div class="page-head">
    <div>
        <h1 class="page-title">Mis informes</h1>
        <p class="page-sub">Informes de tus grupos de conexión</p>
    </div>
...
<form method="GET" action="{{ route('informes.index') }}" class="card animate-fade-in-up mb-24">
...
<div class="card animate-fade-in-up">
    <div class="card-header">
        <div>
            ...
            <p class="card-sub">Todos tus informes registrados</p>
        </div>
    </div>
    ...
    @if ($reports->isEmpty())
        <div class="empty">
            ...
            <p>Registra tu primer informe de grupo de conexión.</p>
        </div>
    @else
